  ...
  h = /* @__PURE__ */ o((e) => {
    ...
    function xi(e, t, n, r, a, o) {
      ...
      if (((r = e), typeof e == "function")) vi(e) && (s = 1)
        ...
        a: switch (e) {
          ...
          case ee:
            return ((e = _i(13, n, t, a)), (e.elementType = ee), (e.lanes = o), e)
          case te:
            return ((e = _i(19, n, t, a)), (e.elementType = te), (e.lanes = o), e)
          default:
    ...
    function Wa(e) {
      ...
      function l(e, t, n, r) {
        ...
        return i === y
          ...
          : t !== null && (t.elementType === i || (typeof i == "object" && i && i.$$typeof === T && Fa(i) === t.type))
    ...
    function Za(e, t, n) {
      ...
      if (((r = r.shared), W & 2)) {
        var i = r.pending
        return (
          i === null ? (t.next = t) : ((t.next = i.next), (i.next = t)), (r.pending = t), (t = mi(e)), pi(e, null, n), t
        )
      }
    ...
    function ss(e, t, n) {
      ...
      var i = t.queue,
        a = i.dispatch
      return (
        n !== t.memoizedState && ((P.flags |= 2048), us(9, { destroy: void 0 }, cs.bind(null, i, n), null)), [r, a, e]
      )
    }
    function cs(e, t) {
      e.action = t
    ...
    function kc(e, t, n) {
      return (
        Ga(t, e.child, null, n), (e = Dc(t, t.pendingProps.children)), (e.flags |= 2), (t.memoizedState = null), e
      )
    }
    function Ac(e, t, n) {
      e.lanes |= t
    ...
    function Uc(e, t) {
      switch ((Bi(t), t.tag)) {
        ...
        case 23:
          return (
            _o(t), lo(), e !== null && O(Ta), (e = t.flags), e & 65536 ? ((t.flags = (e & -65537) | 128), t) : null
          )
        case 24:
          return (ra(M), null)
        case 25:
      ...
      gn(function () {
        ...
        if (!(t & 7)) {
          ...
          a: {
            ...
            ;(y && y(e, c, r),
              e === "focusout" && r && c.type === "number" && r.memoizedProps.value != null && Xt(c, "number", c.value))
          }
...
var w = {
  ...
  oe = (e) => {
    ...
    let n = t.offsetWidth,
      r = 0.985
    ;(n <= 80 ? (r = 0.96) : n <= 150 ? (r = 0.97) : n <= 220 ? (r = 0.98) : n > 600 && (r = 0.995),
      t.style.setProperty("--scale", r.toString()))
  },
  se = (e, t) => {
    let n = () => {
      let t = setTimeout(e)
    ...
    if (!ae || typeof window.requestAnimationFrame != "function" || (ie && document.visibilityState === "hidden"))
      return n()
    let r = t?.frames ?? 2,
  ...
  ce = (e) =>
    Object.keys(e).reduce((t, n) => {
      ...
      if (r || r === 0) {
        let e = n.startsWith("--") ? "" : "--",
          i = typeof r == "number" ? `${r}px` : r
        t[`${e}${n}`] = i
      }
      return t
    }, {}),
  le = (e) => {
    let t = y.Children.toArray(e),
      n = [],
      r = "",
      i = () => {
        r !== "" && (n.push(r), (r = ""))
...
;((0, y.createContext)(null),
  /* @__PURE__ */ o((e, t) => {
    var n = "Expected a function",
      ...
      c = /^0o[0-7]+$/i,
      l = parseInt,
      u = typeof global == "object" && global && global.Object === Object && global,
...
var de = {
  ...
  fe = ({ className: e, size: t, strokeWidth: n, style: r, ...i }) =>
    (0, x.jsx)("div", {
      ...i,
...
var ve = { TransitionGroupChild: "_TransitionGroupChild_1hv1z_1" },
  ye = {
    enter: !1,
    enterActive: !1,
    exit: !1,
  ...
  Se = ({
    ...
    let [_, v] = (0, y.useReducer)(xe, be(o || !1)),
      b = (0, y.useRef)(!1),
      S = (0, y.useRef)(null),
      w = (0, y.useRef)(c)
    w.current = c
    let ee = (0, y.useRef)(l)
    ee.current = l
    let te = (0, y.useRef)(null),
      ne = (0, y.useCallback)(
        (e) => {
          let t = S.current
          if (!(!t || e === te.current))
            switch (((te.current = e), e)) {
              case "enter":
                d(t)
                break
              case "enter-active":
  ...
  Ce = (e) => {
    let { enterMountDelay: t, preventMountTransition: n } = e,
      r = !n && t != null ? t : null,
      [i, a] = (0, y.useState)(r == null)
  ...
  we = (e) => {
    let {
        ...
        enterDuration: s = 0,
        exitDuration: c = 0,
        preventInitialTransition: l = !0,
        enterMountDelay: u,
        insertMethod: d = "append",
        disableAnimations: f = O(),
      } = e,
      p = he(e.onEnter ?? me),
      m = he(e.onEnterActive ?? me),
      h = he(e.onEnterComplete ?? me),
      g = he(e.onExit ?? me),
      _ = he(e.onExitActive ?? me),
      v = he(e.onExitComplete ?? me)
    ...
    return (
      ...
      _e("TransitionGroup", t, y.Children.count(r)),
      f
        ? (0, x.jsx)(x.Fragment, {
...
function je({ logo: e }) {
  ...
  return !e || t
    ? /* @__PURE__ */ (0, x.jsx)("div", {
        className:
          "w-full h-full bg-[var(--color-background-primary-soft-alpha)] flex items-center justify-center overflow-hidden",
...
function Me({ company: e }) {
  let t = e.organization || e.domain || "Unknown Company",
    n = e.emails_count?.total ?? 0,
    r = n > 0 ? `${n.toLocaleString()} email${n === 1 ? " address" : " addresses"}` : null,
    i = e.domain ? `https://company-logo.hunter.io/${e.domain}` : void 0,
    [a, o] = (0, y.useState)(!1),
    [s, c] = (0, y.useState)(!!e.already_saved)
  async function l() {
  ...
  return /* @__PURE__ */ (0, x.jsxs)("li", {
    className:
      "flex items-center gap-3 px-4 py-3 border-b border-[var(--color-border-primary-soft-alt)] hover:bg-[var(--color-surface-secondary)] transition-colors",
    children: [
      /* @__PURE__ */ (0, x.jsx)("div", {
        className:
          "flex-shrink-0 w-[44px] h-[44px] flex items-center justify-center rounded-lg overflow-hidden outline outline-[1.5px] outline-solid outline-[var(--color-border-primary-soft-alt)] -outline-offset-[1.5px]",
    ...
    children: [
      ...
      return /* @__PURE__ */ (0, x.jsx)(
        "div",
        {
          ...
          style: {
            transform: `translate(calc(-50% ${t.dx >= 0 ? "+" : "-"} ${Math.abs(t.dx)}px), calc(-50% ${t.dy >= 0 ? "+" : "-"} ${Math.abs(t.dy)}px))`,
          },
          children: r
...
function Pe() {
  ...
  let i = e.toolOutput,
    a = Array.isArray(i?.data) ? i.data : Array.isArray(i) ? i : [],
    o = i?.meta?.results ?? a.length,
    s = i?.meta?.permalink
  if (
    ((0, y.useEffect)(() => {
      let e = a
        .slice(5, 15)
        .filter((e) => !!e.domain)
        .map((e) => `https://company-logo.hunter.io/${e.domain}`)
      ;(async () => {
        let t = []
        for (let n of e) {
          if (t.length >= 2) break
  ...
  let c = a.slice(0, 5),
    l = Math.max(0, o - c.length)
  function u() {
    let e = s || "https://hunter.io/discover",
      t = e
    try {
      let n = new URL(e)
  ...
  return /* @__PURE__ */ (0, x.jsxs)("div", {
    className:
      "w-full rounded-2xl border border-[0.5px] border-[var(--color-border-primary-outline)] shadow-[var(--shadow-300)] p-4",
    children: [
      /* @__PURE__ */ (0, x.jsx)("div", {
        className: "mb-2",
        children: /* @__PURE__ */ (0, x.jsxs)("h2", {
          className: "text-lg font-medium text",
          children: [o.toLocaleString(), " ", o === 1 ? "company" : "companies", " match your filters"],
        }),
      }),
      /* @__PURE__ */ (0, x.jsx)("ul", {
        ...
        /* @__PURE__ */ (0, x.jsxs)("footer", {
          ...
          children: [
            /* @__PURE__ */ (0, x.jsxs)("div", {
              ...
              children: [
                /* @__PURE__ */ (0, x.jsx)(Ne, { logos: n }),
                /* @__PURE__ */ (0, x.jsxs)("span", {
                  className: "text-secondary",
                  children: ["+ ", l.toLocaleString(), " more"],
                }),
              ],
            }),
            /* @__PURE__ */ (0, x.jsx)(Ee, {
...
Fe &&
  (0, b.createRoot)(Fe).render(
    /* @__PURE__ */ (0, x.jsx)(y.StrictMode, { children: /* @__PURE__ */ (0, x.jsx)(Pe, {}) }),
  )
//#endregion
