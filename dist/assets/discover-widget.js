...
//#endregion
//#region node_modules/.pnpm/@openai+apps-sdk-ui@0.2.1_@types+react-dom@19.2.3_@types+react@19.2.14__@types+react@19_b84ff441c5c4863f2271074d796d4f56/node_modules/@openai/apps-sdk-ui/dist/es/lib/environment.js
var w = {
	BASE_URL: "/",
	DEV: !1,
	MODE: "production",
...
(0, y.createContext)(null), (/* @__PURE__ */ o(((e, t) => {
...
var D = typeof window < "u" ? y.useLayoutEffect : y.useEffect;
function ue(e, t) {
	let n = (0, y.useRef)(e);
	D(() => {
		n.current = e;
...
}, fe = ({ className: e, size: t, strokeWidth: n, style: r, ...i }) => (0, x.jsx)("div", {
	...i,
	className: C(de.LoadingIndicator, e),
	style: r || ce({
		"indicator-size": t,
		"indicator-stroke": n
	})
...
//#endregion
//#region node_modules/.pnpm/@openai+apps-sdk-ui@0.2.1_@types+react-dom@19.2.3_@types+react@19.2.14__@types+react@19_b84ff441c5c4863f2271074d796d4f56/node_modules/@openai/apps-sdk-ui/dist/es/components/Transition/getDisableAnimations.js
var O = () => T, k = (e, t = !1, n = "TransitionGroup") => {
	let r = [];
...
var ve = { TransitionGroupChild: "_TransitionGroupChild_1hv1z_1" }, ye = {
	enter: !1,
	enterActive: !1,
	exit: !1,
	exitActive: !1,
...
}, Se = ({ ref: e, as: t, children: n, className: r, transitionId: i, style: a, preventMountTransition: o, shouldRender: s, enterDuration: c, exitDuration: l, removeChild: u, onEnter: d, onEnterActive: f, onEnterComplete: p, onExit: m, onExitActive: h, onExitComplete: g }) => {
	let [_, v] = (0, y.useReducer)(xe, be(o || !1)), b = (0, y.useRef)(!1), S = (0, y.useRef)(null), w = (0, y.useRef)(c);
	w.current = c;
	let ee = (0, y.useRef)(l);
	ee.current = l;
	...
	return y.useLayoutEffect(() => {
		...
		ref: pe([S, e]),
		className: C(r, ve.TransitionGroupChild),
	...
	return ue(() => a(!0), i ? null : r), i ? (0, x.jsx)(Se, { ...e }) : null;
}, we = (e) => {
	let { ref: t, as: n = "span", children: r, className: i, transitionId: a, style: o, enterDuration: s = 0, exitDuration: c = 0, preventInitialTransition: l = !0, enterMountDelay: u, insertMethod: d = "append", disableAnimations: f = O() } = e, p = he(e.onEnter ?? me), m = he(e.onEnterActive ?? me), h = he(e.onEnterComplete ?? me), g = he(e.onExit ?? me), _ = he(e.onExitActive ?? me), v = he(e.onExitComplete ?? me);
	...
	return (0, y.useLayoutEffect)(() => {
		...
		d,
		b
	]), _e("TransitionGroup", t, y.Children.count(r)), f ? (0, x.jsx)(x.Fragment, { children: y.Children.map(r, (e) => (0, x.jsx)(n, {
		ref: t,
		className: i,
		style: o,
		"data-transition-id": a,
		children: e
	})) }) : (0, x.jsx)(x.Fragment, { children: S.map(({ component: e, ...r }) => (0, x.jsx)(Ce, {
		...r,
		as: n,
		className: i,
		transitionId: a,
	...
	return (0, x.jsxs)("button", {
		...
		children: [(0, x.jsx)(we, {
			...
			enterDuration: 250,
			exitDuration: 150,
			children: l && (0, x.jsx)(fe, {}, "loader")
		}), (0, x.jsx)("span", {
			className: Te.ButtonInner,
			children: E(p)
		})]
	});
}, De = (e) => (0, x.jsx)("svg", {
...
//#endregion
//#region src/discover-widget.tsx
function Ae() {
	let e = window.openai ?? {};
	return {
...
function je({ logo: e }) {
	...
	return !e || t ? /* @__PURE__ */ (0, x.jsx)("div", {
		className: "w-full h-full bg-[var(--color-background-primary-soft-alpha)] flex items-center justify-center overflow-hidden",
		children: /* @__PURE__ */ (0, x.jsx)(De, { className: "w-6 h-6 text-tertiary" })
	}) : /* @__PURE__ */ (0, x.jsx)("div", {
		className: "w-full h-full bg-[var(--color-surface-primary)]",
...
function Me({ company: e }) {
	let t = e.organization || e.domain || "Unknown Company", n = e.emails_count?.total ?? 0, r = n > 0 ? `${n.toLocaleString()} email${n === 1 ? " address" : " addresses"}` : null, i = e.domain ? `https://company-logo.hunter.io/${e.domain}` : void 0, [a, o] = (0, y.useState)(!1), [s, c] = (0, y.useState)(!!e.already_saved);
	async function l() {
		if (a || s || !e.domain) return;
		let t = window.openai;
		if (t?.callTool) {
			o(!0);
			try {
	...
	return /* @__PURE__ */ (0, x.jsxs)("li", {
		className: "flex items-center gap-3 px-4 py-3 border-b border-[var(--color-border-primary-soft-alt)] hover:bg-[var(--color-surface-secondary)] transition-colors",
		children: [
			/* @__PURE__ */ (0, x.jsx)("div", {
				className: "flex-shrink-0 w-[44px] h-[44px] flex items-center justify-center rounded-lg overflow-hidden outline outline-[1.5px] outline-solid outline-[var(--color-border-primary-soft-alt)] -outline-offset-[1.5px]",
				children: /* @__PURE__ */ (0, x.jsx)(je, { logo: i })
			}),
			/* @__PURE__ */ (0, x.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, x.jsxs)("span", {
					...
					children: [/* @__PURE__ */ (0, x.jsx)("span", {
						...
						children: t
					}), e.hiring && /* @__PURE__ */ (0, x.jsx)("span", {
						className: "text-secondary",
						children: "\xA0· Hiring"
					})]
				}), (r || e.industry || e.location) && /* @__PURE__ */ (0, x.jsxs)("span", {
					className: "text-sm text-secondary flex items-center gap-1 block",
					children: [
						r && /* @__PURE__ */ (0, x.jsx)("span", {
							className: "whitespace-nowrap",
							children: r
						}),
						r && e.industry && /* @__PURE__ */ (0, x.jsx)("span", {
							className: "whitespace-nowrap",
							"aria-hidden": "true",
							children: "·"
						}),
						e.industry && /* @__PURE__ */ (0, x.jsx)("span", {
							className: "truncate",
							children: e.industry
						}),
						(r || e.industry) && e.location && /* @__PURE__ */ (0, x.jsx)("span", {
							className: "whitespace-nowrap",
							"aria-hidden": "true",
							children: "·"
						}),
						e.location && /* @__PURE__ */ (0, x.jsx)("span", {
							className: "whitespace-nowrap",
							children: e.location
						})
					]
			...
			/* @__PURE__ */ (0, x.jsx)(Ee, {
				...
				inert: s,
				onClick: l,
				"aria-label": `Add ${t} to saved companies`,
				children: s ? /* @__PURE__ */ (0, x.jsx)(Oe, {}) : /* @__PURE__ */ (0, x.jsx)(ke, {})
			})
		]
	});
}
function Ne({ logos: e }) {
	return /* @__PURE__ */ (0, x.jsx)("div", {
		...
		children: [{
			...
			let n = e[t.index], r = !!n;
			return /* @__PURE__ */ (0, x.jsx)("div", {
				className: `absolute top-1/2 left-1/2 w-[32px] h-[32px] rounded-md overflow-hidden border border-white outline outline-[1.5px] outline-solid outline-[var(--color-border-primary-soft-alt)] -outline-offset-[1.5px] flex items-center justify-center ${r ? "bg-[var(--color-text-primary-solid)]" : "bg-[var(--color-background-primary-soft)]"} ${t.zClass}`,
				style: { transform: `translate(calc(-50% ${t.dx >= 0 ? "+" : "-"} ${Math.abs(t.dx)}px), calc(-50% ${t.dy >= 0 ? "+" : "-"} ${Math.abs(t.dy)}px))` },
				children: r ? /* @__PURE__ */ (0, x.jsx)("img", {
					src: n,
					alt: "",
					className: "w-full h-full object-cover"
				}) : /* @__PURE__ */ (0, x.jsx)(De, { className: "w-6 h-6 text-tertiary" })
			}, t.index);
		})
	});
}
function Pe() {
	let [e, t] = (0, y.useState)(Ae), [n, r] = (0, y.useState)([]);
	(0, y.useEffect)(() => {
		function e() {
			t(Ae());
		}
	...
	let i = e.toolOutput, a = Array.isArray(i?.data) ? i.data : Array.isArray(i) ? i : [], o = i?.meta?.results ?? a.length, s = i?.meta?.permalink;
	if ((0, y.useEffect)(() => {
		let e = a.slice(5, 15).filter((e) => !!e.domain).map((e) => `https://company-logo.hunter.io/${e.domain}`);
		(async () => {
			let t = [];
			for (let n of e) {
				if (t.length >= 2) break;
				await new Promise((e) => {
					let t = new Image();
					t.addEventListener("load", () => e(!0)), t.addEventListener("error", () => e(!1)), t.src = n;
				}) && t.push(n);
			}
			r(t);
		})();
	}, [a]), !e.toolOutput) return /* @__PURE__ */ (0, x.jsx)("span", {
		className: "text-sm text-secondary",
		role: "status",
		"aria-live": "polite",
		children: "Loading discover results..."
	});
	if (a.length === 0) return /* @__PURE__ */ (0, x.jsx)("span", {
		className: "text-sm text-secondary",
		role: "status",
		children: "No companies found."
	});
	let c = a.slice(0, 5), l = Math.max(0, o - c.length);
	function u() {
		let e = s || "https://hunter.io/discover", t = e;
		try {
			let n = new URL(e);
			n.searchParams.set("utm_source", "hunter-chatgpt"), t = n.toString();
		} catch {}
		let n = window.openai;
		n?.openExternal ? n.openExternal({ href: t }) : window.open(t, "_blank", "noopener,noreferrer");
	}
	return /* @__PURE__ */ (0, x.jsxs)("div", {
		className: "w-full rounded-2xl border border-[0.5px] border-[var(--color-border-primary-outline)] shadow-[var(--shadow-300)] p-4",
		children: [
			/* @__PURE__ */ (0, x.jsx)("div", {
				className: "mb-2",
				children: /* @__PURE__ */ (0, x.jsxs)("h2", {
					className: "text-lg font-medium text",
					children: [
						o.toLocaleString(),
						" ",
						o === 1 ? "company" : "companies",
						" match your filters"
					]
				})
			}),
			/* @__PURE__ */ (0, x.jsx)("ul", {
				className: "-mx-4 py-1 list-none",
				children: c.map((e, t) => /* @__PURE__ */ (0, x.jsx)(Me, { company: e }, e.domain ?? t))
			}),
			l > 0 && /* @__PURE__ */ (0, x.jsxs)("footer", {
				className: "flex items-center justify-between pt-2",
				children: [/* @__PURE__ */ (0, x.jsxs)("div", {
					className: "flex items-center gap-3",
					children: [/* @__PURE__ */ (0, x.jsx)(Ne, { logos: n }), /* @__PURE__ */ (0, x.jsxs)("span", {
						className: "text-secondary",
						children: [
							"+ ",
							l.toLocaleString(),
...
var Fe = document.getElementById("root");
Fe && (0, b.createRoot)(Fe).render(/* @__PURE__ */ (0, x.jsx)(y.StrictMode, { children: /* @__PURE__ */ (0, x.jsx)(Pe, {}) }));
//#endregion
