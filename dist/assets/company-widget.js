...
var pe = {
  ...
  O = ({ className: e, size: t, strokeWidth: n, style: r, ...i }) =>
    (0, x.jsx)("div", {
      ...i,
...
var be = { TransitionGroupChild: "_TransitionGroupChild_1hv1z_1" },
  xe = {
    enter: !1,
    enterActive: !1,
    exit: !1,
  ...
  we = ({
    ...
    let [_, v] = (0, y.useReducer)(Ce, Se(o || !1)),
      b = (0, y.useRef)(!1),
      S = (0, y.useRef)(null),
      w = (0, y.useRef)(c)
    w.current = c
  ...
  Ee = (e) => {
    let {
        ...
        disableAnimations: f = me(),
      } = e,
      p = _e(e.onEnter ?? ge),
      m = _e(e.onEnterActive ?? ge),
      h = _e(e.onEnterComplete ?? ge),
      g = _e(e.onExit ?? ge),
      _ = _e(e.onExitActive ?? ge),
      v = _e(e.onExitComplete ?? ge)
    ...
    return (
      ...
      ye("TransitionGroup", t, y.Children.count(r)),
      f
        ? (0, x.jsx)(x.Fragment, {
...
function je(e) {
  let t = e.toolOutput?.data || e.toolOutput || {},
    n = t.already_saved ?? t.alreadySaved
  return {
    ...t,
    alreadySaved: n,
  }
...
function Pe(e) {
  if (!e) return
  let t = window.openai,
    n = new URL(`https://hunter.io/search/${e}`)
  ;(n.searchParams.set("utm_source", "hunter-chatgpt"),
    t?.openExternal
      ? t.openExternal({ href: n.toString() })
      : window.open(n.toString(), "_blank", "noopener,noreferrer"))
}
function Fe() {
  let [e, t] = (0, y.useState)(Me),
    n = je(e),
    [r, i] = (0, y.useState)(!1),
    [a, o] = (0, y.useState)(!!n.alreadySaved)
  ;(0, y.useEffect)(() => {
    function e() {
      let e = Me()
  ...
  let s = !e.toolOutput,
    c = je(e),
    l = c.emailsCount?.total ?? c.site?.emailAddresses?.length ?? 0
  async function u() {
  ...
  return s
    ? /* @__PURE__ */ (0, x.jsxs)("div", {
        className:
          "w-full max-w-sm rounded-2xl bg-[var(--color-surface)] border border-[0.5px] border-[var(--color-border-primary-outline)] shadow-[var(--shadow-300)]",
        children: [
          /* @__PURE__ */ (0, x.jsx)("div", { className: "m-2 rounded-xl bg-neutral-100 min-h-[232px] animate-pulse" }),
          /* @__PURE__ */ (0, x.jsxs)("div", {
            ...
            children: [
              /* @__PURE__ */ (0, x.jsxs)("div", {
                ...
                children: [
                  /* @__PURE__ */ (0, x.jsx)("div", { className: "h-4 w-32 rounded bg-neutral-200" }),
                  /* @__PURE__ */ (0, x.jsx)("div", { className: "h-3 w-20 rounded bg-neutral-200" }),
                ],
              }),
              ...
              /* @__PURE__ */ (0, x.jsxs)("div", {
                className: "space-y-2",
                children: [
                  /* @__PURE__ */ (0, x.jsx)("div", { className: "h-3 w-full rounded bg-neutral-200" }),
                  /* @__PURE__ */ (0, x.jsx)("div", { className: "h-3 w-5/6 rounded bg-neutral-200" }),
                ],
              }),
              /* @__PURE__ */ (0, x.jsxs)("div", {
                className: "flex gap-3 pt-4",
                children: [
                  /* @__PURE__ */ (0, x.jsx)("div", { className: "h-10 flex-1 rounded-full bg-neutral-200" }),
                  /* @__PURE__ */ (0, x.jsx)("div", { className: "h-10 flex-1 rounded-full bg-neutral-200" }),
                ],
              }),
            ],
                ...
                children: [
                  ...
                  l > 0 &&
                    /* @__PURE__ */ (0, x.jsxs)("span", {
                      ...
                      children: [l, " email ", l === 1 ? "address" : "addresses"],
                    }),
                ],
              }),
              /* @__PURE__ */ (0, x.jsxs)("span", {
                ...
                children: [
                  ...
                  c.metrics?.employees &&
                    /* @__PURE__ */ (0, x.jsxs)(x.Fragment, {
                      children: [c.metrics.employees, " employees", c.location && " · "],
                    }),
...
;(0, b.createRoot)(document.getElementById("root")).render(
  /* @__PURE__ */ (0, x.jsx)(y.StrictMode, { children: /* @__PURE__ */ (0, x.jsx)(Fe, {}) }),
)
//#endregion
